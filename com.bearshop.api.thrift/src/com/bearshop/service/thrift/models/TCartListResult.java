...
public class TCartListResult implements org.apache.thrift.TBase<TCartListResult, TCartListResult._Fields>, java.io.Serializable, Cloneable, Comparable<TCartListResult> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TCartListResult");
  ...
  static {
    schemes.put(StandardScheme.class, new TCartListResultStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TCartListResultTupleSchemeFactory());
  }

  public short error; // required
  public List<TCart> listData; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.LIST_DATA, new org.apache.thrift.meta_data.FieldMetaData("listData", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TCart.class))));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TCartListResult.class, metaDataMap);
  }

  public TCartListResult() {
  }
   ...
   */
  public TCartListResult(TCartListResult other) {
    __isset_bitfield = other.__isset_bitfield;
    this.error = other.error;
    if (other.isSetListData()) {
      List<TCart> __this__listData = new ArrayList<TCart>(other.listData.size());
      for (TCart other_element : other.listData) {
        __this__listData.add(new TCart(other_element));
      }
  ...
  public TCartListResult deepCopy() {
    return new TCartListResult(this);
  }
  ...
  public TCartListResult setError(short error) {
    this.error = error;
    setErrorIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<TCart> getListDataIterator() {
    return (this.listData == null) ? null : this.listData.iterator();
  }

  public void addToListData(TCart elem) {
    if (this.listData == null) {
      this.listData = new ArrayList<TCart>();
    }
    this.listData.add(elem);
  }

  public List<TCart> getListData() {
    return this.listData;
  }

  public TCartListResult setListData(List<TCart> listData) {
    this.listData = listData;
    return this;
  }
  ...
  public TCartListResult setTotalRecord(long totalRecord) {
    this.totalRecord = totalRecord;
    setTotalRecordIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TCartListResult)
      return this.equals((TCartListResult)that);
    return false;
  }

  public boolean equals(TCartListResult that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TCartListResult other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TCartListResult(");
    boolean first = true;
  ...
  private static class TCartListResultStandardSchemeFactory implements SchemeFactory {
    public TCartListResultStandardScheme getScheme() {
      return new TCartListResultStandardScheme();
    }
  }

  private static class TCartListResultStandardScheme extends StandardScheme<TCartListResult> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TCartListResult struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.listData = new ArrayList<TCart>(_list8.size);
                for (int _i9 = 0; _i9 < _list8.size; ++_i9)
                {
                  TCart _elem10;
                  _elem10 = new TCart();
                  _elem10.read(iprot);
                  struct.listData.add(_elem10);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TCartListResult struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.listData != null) {
        oprot.writeFieldBegin(LIST_DATA_FIELD_DESC);
        {
          ...
          for (TCart _iter11 : struct.listData)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class TCartListResultTupleSchemeFactory implements SchemeFactory {
    public TCartListResultTupleScheme getScheme() {
      return new TCartListResultTupleScheme();
    }
  }

  private static class TCartListResultTupleScheme extends TupleScheme<TCartListResult> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TCartListResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetListData()) {
        {
          ...
          for (TCart _iter12 : struct.listData)
          {
            _iter12.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TCartListResult struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.listData = new ArrayList<TCart>(_list13.size);
          for (int _i14 = 0; _i14 < _list13.size; ++_i14)
          {
            TCart _elem15;
            _elem15 = new TCart();
            _elem15.read(iprot);
            struct.listData.add(_elem15);
          }
        }
        struct.setListDataIsSet(true);
      }
