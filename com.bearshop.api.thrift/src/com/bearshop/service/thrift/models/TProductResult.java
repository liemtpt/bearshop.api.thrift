...
public class TProductResult implements org.apache.thrift.TBase<TProductResult, TProductResult._Fields>, java.io.Serializable, Cloneable, Comparable<TProductResult> {
  ...
  static {
    schemes.put(StandardScheme.class, new TProductResultStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TProductResultTupleSchemeFactory());
  }

  public short error; // required
  public TProduct value; // required
  ...
  public TProductResult(TProductResult other) {
    ...
    if (other.isSetValue()) {
      this.value = new TProduct(other.value);
    }
  }
  ...
  public TProductResult setError(short error) {
    this.error = error;
    setErrorIsSet(true);
    return this;
  }
  ...
  public TProduct getValue() {
    return this.value;
  }

  public TProductResult setValue(TProduct value) {
    this.value = value;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TProductResult(");
    boolean first = true;
  ...
  private static class TProductResultStandardSchemeFactory implements SchemeFactory {
    public TProductResultStandardScheme getScheme() {
      return new TProductResultStandardScheme();
    }
  }

  private static class TProductResultStandardScheme extends StandardScheme<TProductResult> {
  ...
  private static class TProductResultTupleSchemeFactory implements SchemeFactory {
    public TProductResultTupleScheme getScheme() {
      return new TProductResultTupleScheme();
    }
  }

  private static class TProductResultTupleScheme extends TupleScheme<TProductResult> {
